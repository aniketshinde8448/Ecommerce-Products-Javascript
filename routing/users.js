...
var prodschem = require('../schema/prodschema');
var userschem = require('../schema/userschema');
...
exports.register = function (server, options, next) {
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            userschem.usr.findAll({ where: { user_type: "vendor" } }).then(function (allusers) {
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            userschem.usr.update({ user_name: uname, user_pass: upass }, { where: { user_email: umail } }).then(function () {
