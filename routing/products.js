var prodschema = require('../schema/prodschema');
...
exports.register = function (server, options, next) {
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            prodschema.prod.findAll({}).then(function (allprods) {
    ...
    server.route({
        ...
        handler: function (request, reply) {
            ...
            prodschema.prod.update({ product_name: pname, product_desc: pdesc, product_category: pcat, product_price: pprice, is_Active: isact }, { where: { uuid: uid } }).then(function () {
